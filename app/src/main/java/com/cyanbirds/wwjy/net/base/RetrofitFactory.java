package com.cyanbirds.wwjy.net.base;

import android.support.annotation.NonNull;

import com.cyanbirds.wwjy.BuildConfig;
...
public class RetrofitFactory {
    ...
    private static final Interceptor cacheControlInterceptor = chain -> {
        ...
        if (!Utils.isNetworkConnected(CSApplication.getInstance())) {
            ...
            synchronized (RetrofitFactory.class) {
                if (retrofit == null) {
                    ...
                    ClearableCookieJar cookieJar =
                            new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(CSApplication.getInstance()));
