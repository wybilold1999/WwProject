package com.cyanbirds.wwjy.ui.widget;
...
public class MultiImageView extends LinearLayout {
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		...
		View view = LayoutInflater.from(mContext).inflate(R.layout.item_dynamic_img, null);
		ColorFilterImageView imageView = (ColorFilterImageView) view.findViewById(R.id.dynamic_img);
